...
# Test with the CBT session audio
audio_file = "sample-audio/LIVE Cognitive Behavioral Therapy Session (1).mp3"
...
test_file = "test_1min.mp3"
one_minute.export(test_file, format="mp3")
